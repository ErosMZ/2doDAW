...
document.getElementById("boton").addEventListener("click", function(){
    ...
    var seleccionado = document.getElementById('desplegable');
    ...
    if (nombre == "" || email == "" || dni == "") {
        ...
        if (valor.includes("1")) {
            ...
            var contened = document.getElementById("listado1")
            ...
            var contened = document.getElementById("listado2")
            var parrafo = document.createElement("p")
            var texto = document.createTextNode(nombre + " con " + "DNI "+ dni + " y e-email " + email)
            ...
            var contened = document.getElementById("listado3")
            var parrafo = document.createElement("p")
            var texto = document.createTextNode(nombre + " con " + "DNI "+ dni + " y e-email " + email)
        ...
        }else if(valor.includes("4")){

            var contened = document.getElementById("listado4")
            var parrafo = document.createElement("p")
            var texto = document.createTextNode(nombre + " con " + "DNI "+ dni + " y e-email " + email)
...
const parrafos = document.querySelectorAll('p');
    ...
    parrafos.forEach(parrafo =>{
        parrafo.addEventListener('click', function() {
            ...
            alert("Texto seleccionado: " + texto); 
        });
    }) 
