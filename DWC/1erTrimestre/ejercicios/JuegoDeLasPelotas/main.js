    ...
    if (eliminarTodas == 1 && eliminarUnColor== 0) {
        ...
        divsArray.forEach(function(div) {
            div.addEventListener('click', function() {
                ...
                if (colorFondo == "blue") {
                    console.log("El " + div.className + "tiene un fondo azul.");
                }else if(colorFondo == "green"){
                    console.log("El " + div.className + " tiene un fondo green.");
                }else if(colorFondo == "red"){
                    console.log("El " + div.className + " tiene un fondo red.");
                }else{
                    console.log("El " + div.className + " tiene un fondo yellow.");
                }
            });
        });
    }else{
